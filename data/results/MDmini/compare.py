...
pylab.xlim([1E2,1E5])
pylab.ylim([0,10])
pylab.xlabel('$Number\ of\ Particles$',fontsize=20)
pylab.ylabel('$Concentration$',fontsize=20)
...
pylab.xlabel("$Velocity\ Method$",fontsize=20)
pylab.ylabel("$Mass\ Method$",fontsize=20)
...
pylab.xlabel("$Mass\ Method$",fontsize=20)
pylab.ylabel("$Density\ Method$",fontsize=20)
...
pylab.xlim(xmin=np.amin(c_vel),xmax=np.amax(c_vel))
pylab.ylim(ymin=np.amin(c_vel),ymax=np.amax(c_vel))
pylab.xlabel("$Density\ Method$",fontsize=20)
pylab.ylabel("$Velocity\ Method$",fontsize=20)
