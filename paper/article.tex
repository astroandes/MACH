...
The bold lines in Figure \ref{fig:concentrations} corresponds to the median and the thinner lines corresponds to the quartiles. As we can see the velocity method has a greater dispersion compared to the other two.
