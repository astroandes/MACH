...
$15\%-20\%$ for halos sampled with $200$ particles, and $7\%$-$8\%$
for halos sampled with $500$ particles. 
To control this bias level we propose a new algorithm based on the
...
low levels as in the new method, only halos sampled
