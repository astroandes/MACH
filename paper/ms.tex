...
\section{Bootstrapping to estimate biases}
\label{sec:bootstrapping}

Avoiding biases with varying simulation resolution is one of the most
important goals of a robust method to estimate halo concentration. 
We propose bootstraping individual high resolution halos to quantify these
possible biases.
