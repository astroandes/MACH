...
%DIF ADD ms.tex       Thu Aug 25 17:15:06 2016
...
formation takes place, and where the effects of baryon physics on \DIFaddbegin \DIFadd{the
}\DIFaddend dark matter distribution are still unknown. 
...
diagonal elements and must give similar curves of \DIFdelbegin \DIFdel{$\chi^{2}(c)$}\DIFdelend \DIFaddbegin \DIFadd{$\chi^{2}(c,x_i)$}\DIFaddend -$c$
...
\mbox{%DIFAUXCMD
\citep{2008MNRAS.391.1685S}
}%DIFAUXCMD
yielded similar values for the
...
\DIFadd{using the new method}\DIFaddend . 
...
\vspace{0.1cm}
 ...
 }\DIFdelend \DIFaddbegin \DIFadd{We acknowledge }\DIFaddend financial support from \DIFdelbegin \DIFdel{Vicerrector\'ia de Investigaciones at Uniandes
 through a FAPA project. JCMC acknowledges financial support from
 ``Estrategia de  sostenibilidad 2014-2015, }\DIFdelend \DIFaddbegin \DIFadd{Uniandes
 and }\DIFaddend Universidad de Antioquia\DIFdelbegin \DIFdel{''}\DIFdelend \DIFaddbegin \DIFadd{. 
...
the presentation of these results}\DIFaddend . 
