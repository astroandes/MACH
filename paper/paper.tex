...
Galaxy properties are driven by its dark matter halo host.
A dark matter halo's concentration is on the key structural
properties. 
[EN QUE MODELOS IMPORTA LA CONCENTRACION?]
This drives the pursue to make the concentration estimates of
simulated halos as reliable as possible. 
Here we show the radially integrated mass profile can be converted
into a powerful tool to estimate concentratios.
